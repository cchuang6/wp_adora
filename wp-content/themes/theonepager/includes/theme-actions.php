...
?>
	...
	<a id="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'description' ) ); ?>" style="border-bottom: 2px solid #fff;margin: 0 auto; width:70%;padding-bottom: 20px;">
