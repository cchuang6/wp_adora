...
?>
	<div id="content" class="home-widgets">
		...
		<?php
			get_template_part('includes/first_section');
			get_template_part('includes/second_section');
			get_template_part('includes/third_section');
			get_template_part('includes/fourth_section');
			get_template_part('includes/fifth_section');
		?>
		</div>
		<?
