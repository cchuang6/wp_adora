...
class UT2_tools_translate_admin_area_Tweak {
	function settings( ) {
		return UT2_Helper::field( 'tools_translate_admin_area', 'translate_text', array(
			'title'    =>  __( 'Translate Admin area', UT2_SLUG ),
		) );
	}
