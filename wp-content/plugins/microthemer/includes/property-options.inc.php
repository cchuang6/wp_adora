...
$propertyOptions['font']['font_family'] = array(
    'short_label' => esc_html(_x('Family', 'noun: Font Family', 'tvr-microthemer')),
    'label' => esc_attr__('Font Family', 'tvr-microthemer'),
...
$propertyOptions['font']['google_font'] = array(
    'short_label' => esc_html__('Google Font', 'tvr-microthemer'),
    'label' => esc_attr__('Google Font Family', 'tvr-microthemer'),
...
$propertyOptions['font']['color'] = array(
    'short_label' => esc_html(_x('Color', 'noun', 'tvr-microthemer')),
    'label' => esc_attr(_x('Color', 'noun', 'tvr-microthemer')),
...
$propertyOptions['font']['font_size'] = array(
    'short_label' => esc_html(_x('Size', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Font Size', 'tvr-microthemer'),
    ...
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
    'icon' => '21',
    // ref
...
$propertyOptions['font']['line_height'] = array(
    'short_label' => esc_html__('Line Height', 'tvr-microthemer'),
    'label' => esc_attr__('Line Height', 'tvr-microthemer'),
    'input-class' => 'size-0',
    'auto' => array(
        '%' => array(
            'node' => 'element',
...
$propertyOptions['font']['font_weight'] = array(
    'short_label' => esc_html(_x('Weight', 'noun: Font Weight', 'tvr-microthemer')),
    'label' => esc_attr__('Font Weight', 'tvr-microthemer'),
...
$propertyOptions['font']['font_style'] = array(
    'short_label' => esc_html(_x('Style', 'noun: Font Style', 'tvr-microthemer')),
    'label' => esc_attr__('Font Style', 'tvr-microthemer'),
    'field-class' => 'icon-size-0a',
    'type' => 'combobox',
    'select_options' => array(
		'',
...
$propertyOptions['font']['text_decoration'] = array(
    'short_label' => esc_html__('Decoration', 'tvr-microthemer'),
    'label' => esc_attr__('Text Decoration', 'tvr-microthemer'),
    'field-class' => 'icon-size-0a',
    'input-class' => 'size-5',
    'type' => 'combobox',
    'select_options' => array(
...
$propertyOptions['font']['font_variant'] = array(
    'short_label' => esc_html__('Variant', 'tvr-microthemer'),
    'label' => esc_attr__('Font Variant', 'tvr-microthemer'),
...
$propertyOptions['text']['text_align'] = array(
    'short_label' => esc_html__('Text Align', 'tvr-microthemer'),
    'label' => esc_attr__('Text Align', 'tvr-microthemer'),
...
$propertyOptions['text']['text_indent'] = array(
    'short_label' => esc_html(_x('Indent', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Text Indent', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-0b',
    'auto' => array(
        '%' => array(
...
$propertyOptions['text']['text_transform'] = array(
    'short_label' => esc_html__('Transform', 'noun', 'tvr-microthemer'),
    'label' => esc_attr__('Text Transform', 'tvr-microthemer'),
    'input-class' => 'size-4',
    'type' => 'combobox',
    'select_options' => array(
		'',
...
$propertyOptions['text']['word_spacing'] = array(
    'short_label' => esc_html__('Word Spacing', 'tvr-microthemer'),
    'field-class' => 'icon-size-4',
    'input-class' => 'size-0b',
    'auto' => array(
        '%' => false
    ),
    'label' => esc_attr__('Word Spacing', 'tvr-microthemer'),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
    'icon' => '22, 4',
    // ref
...
$propertyOptions['text']['letter_spacing'] = array(
    'short_label' => esc_html__('Letter Spacing', 'tvr-microthemer'),
    'label' => esc_attr__('Letter Spacing', 'tvr-microthemer'),
    'input-class' => 'size-0b',
    'auto' => array(
        '%' => false
    ),
...
$propertyOptions['text']['word_wrap'] = array(
    'short_label' => esc_html__('Word Wrap', 'tvr-microthemer'),
    'label' => esc_attr__('Word Wrap', 'tvr-microthemer'),
    'input-class' => 'size-4a',
    'type' => 'combobox',
    'select_options' => array(
		'',
...
$propertyOptions['text']['white_space'] = array(
    'short_label' => esc_html__('White Space', 'tvr-microthemer'),
    'label' => esc_attr__('White Space', 'tvr-microthemer'),
    'input-class' => 'size-3a',
    'type' => 'combobox',
    'select_options' => array(
		'',
...
$propertyOptions['text']['direction'] = array(
    'short_label' => esc_html__('Direction', 'tvr-microthemer'),
    'label' => esc_attr__('Text Direction', 'tvr-microthemer'),
    'input-class' => '',
    'type' => 'combobox',
    'select_options' => array(
		'',
...
$propertyOptions['text']['vertical_align'] = array(
    'short_label' => esc_html__('Vertical Align', 'tvr-microthemer'),
    'label' => esc_attr__('Vertical Align', 'tvr-microthemer'),
    'input-class' => 'size-5',
    'type' => 'combobox',
    'select_options' => array(
        '',
...
$propertyOptions['list']['list_style_type'] = array(
    'short_label' => esc_html(_x('Type', 'noun: List Style Type', 'tvr-microthemer')),
    'label' => esc_attr__('List Style Type', 'tvr-microthemer'),
...
$propertyOptions['list']['list_style_image'] = array(
    'short_label' => esc_html(_x('Image', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('List Style Image', 'tvr-microthemer'),
    'type' => 'combobox',
...
$propertyOptions['list']['list_style_position'] = array(
    'short_label' => esc_html__('Position', 'tvr-microthemer'),
    'label' => esc_attr__('List Style Position', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-2',
    'type' => 'combobox',
    'select_options' => array(
...
$propertyOptions['shadow']['text_shadow_x'] = array(
    'short_label' => esc_html__('X-Offset', 'tvr-microthemer'),
    'label' => esc_attr__('Text Shadow X-offset', 'tvr-microthemer'),
...
$propertyOptions['shadow']['text_shadow_y'] = array(
    'short_label' => esc_html__('Y-Offset', 'tvr-microthemer'),
    'label' => esc_attr__('Text Shadow Y-offset', 'tvr-microthemer'),
    'input-class' => 'size-0b',
    'auto' => array(
        '%' => false
    ),
...
$propertyOptions['shadow']['text_shadow_blur'] = array(
    'short_label' => esc_html(_x('Blur', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Text Shadow Blur', 'tvr-microthemer'),
    'input-class' => 'size-0b',
    'auto' => array(
        '%' => false
    ),
...
$propertyOptions['shadow']['text_shadow_color'] = array(
    'short_label' => esc_html(_x('Color', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Text Shadow Color', 'tvr-microthemer'),
...
$propertyOptions['shadow']['box_shadow_x'] = array(
    'short_label' => esc_html__('X-Offset', 'tvr-microthemer'),
    'label' => esc_attr__('Box Shadow x-offset', 'tvr-microthemer'),
...
$propertyOptions['shadow']['box_shadow_y'] = array(
    'short_label' => esc_html__('Y-Offset', 'tvr-microthemer'),
    'label' => esc_attr__('Box Shadow y-offset', 'tvr-microthemer'),
...
$propertyOptions['shadow']['box_shadow_blur'] = array(
    'short_label' => esc_html(_x('Blur', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Box Shadow Blur', 'tvr-microthemer'),
    'auto' => array(
        '%' => false
    ),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
...
$propertyOptions['shadow']['box_shadow_spread'] = array(
    'short_label' => esc_html(_x('Spread', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Box Shadow Spread', 'tvr-microthemer'),
    'auto' => array(
        '%' => false
    ),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
...
$propertyOptions['shadow']['box_shadow_color'] = array(
    'short_label' => esc_html(_x('Color', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Box Shadow Color', 'tvr-microthemer'),
...
$propertyOptions['shadow']['box_shadow_inset'] = array(
    'short_label' => esc_html(_x('Inset', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Box Shadow Inset', 'tvr-microthemer'),
    //'input-class' => 'size-0b',
    'field-class' => 'last',
    'type' => 'combobox',
    // ref
...
$propertyOptions['background']['background_color'] = array(
    'short_label' => esc_html__('Color', 'noun', 'tvr-microthemer'),
    'label' => esc_attr__('Background Color', 'tvr-microthemer'),
...
$propertyOptions['background']['background_image'] = array(
    'short_label' => esc_html(_x('Image', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Background Image', 'tvr-microthemer'),
    'type' => 'combobox',
    'field-class' => 'last span-3',
    'input-class' => 'bg-image-select size-very-big strictly-dropdown',
    'select_options' => array(
...
$propertyOptions['background']['background_position'] = array(
    'short_label' => esc_html(_x('Position', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Background Position', 'tvr-microthemer'),
    'type' => 'combobox',
...
$propertyOptions['background']['background_repeat'] = array(
    'short_label' => esc_html(_x('Repeat', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Background Repeat', 'tvr-microthemer'),
    'input-class' => 'size-3a',
    'type' => 'combobox',
    'select_options' => array(
		'',
...
$propertyOptions['background']['background_attachment'] = array(
    'short_label' => esc_html__('Attachment', 'tvr-microthemer'),
    'label' => esc_attr__('Background Attachment', 'tvr-microthemer'),
    'type' => 'combobox',
    'select_options' => array(
		'',
        'scroll',
...
$propertyOptions['background']['background_size'] = array(
    'short_label' => esc_html(_x('Size', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Background Size', 'tvr-microthemer'),
    'type' => 'combobox',
    'input-class' => 'size-3a',
    'select_options' => array(
		'',
...
$propertyOptions['background']['background_clip'] = array(
    'short_label' => esc_html(_x('Clip', 'noun', 'tvr-microthemer')),
    'label' => esc_attr__('Background Clip', 'tvr-microthemer'),
    'type' => 'combobox',
    'input-class' => 'size-5',
    'select_options' => array(
		'',
...
$propertyOptions['dimensions']['width'] = array(
    'short_label' => esc_html__('Width', 'tvr-microthemer'),
    'label' => esc_attr__('Width', 'tvr-microthemer'),
    ...
    'input-class' => 'size-1',
    'default_unit' => array('px (implicit)', '%', 'px to %'),
    'icon' => '9',
    // ref
...
$propertyOptions['dimensions']['min_width'] = array(
    'short_label' => esc_html__('Min', 'tvr-microthemer'),
    'label' => esc_attr__('Min Width', 'tvr-microthemer'),
    'input-class' => 'size-1',
    'auto' => array(
        '%' => array(
            'node' => 'parent',
...
$propertyOptions['dimensions']['max_width'] = array(
    'short_label' => esc_html__('Max', 'tvr-microthemer'),
    'label' => esc_attr__('Max Width', 'tvr-microthemer'),
    'input-class' => 'size-1',
    'auto' => array(
        '%' => array(
            'node' => 'parent',
...
$propertyOptions['dimensions']['height'] = array(
    'short_label' => esc_html__('Height', 'tvr-microthemer'),
    'label' => esc_attr__('Height', 'tvr-microthemer'),
...
$propertyOptions['dimensions']['min_height'] = array(
    'short_label' => esc_html__('Min', 'tvr-microthemer'),
    'label' => esc_attr__('Min Height', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-1',
    'auto' => array(
        '%' => array(
...
$propertyOptions['dimensions']['max_height'] = array(
    'short_label' => esc_html__('Max', 'tvr-microthemer'),
    'label' => esc_attr__('Max Height', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-1',
    'auto' => array(
        '%' => array(
...
$propertyOptions['dimensions']['box_sizing'] = array(
    'short_label' => esc_html__('Box Sizing', 'tvr-microthemer'),
    'label' => esc_attr__('Box Sizing', 'tvr-microthemer'),
    'input-class' => 'size-5',
    'type' => 'combobox',
    'select_options' => array(
		'',
...
$propertyOptions['padding_margin']['padding_top'] = array(
    'short_label' => esc_html__('Top', 'tvr-microthemer'),
    'label' => esc_attr__('Padding Top', 'tvr-microthemer'),
...
$propertyOptions['padding_margin']['padding_right'] = array(
    'short_label' => esc_html__('Right', 'tvr-microthemer'),
    'label' => esc_attr__('Padding Right', 'tvr-microthemer'),
    'input-class' => 'size-0',
    'auto' => array(
        '%' => array(
            'node' => 'parent',
...
$propertyOptions['padding_margin']['padding_bottom'] = array(
    'short_label' => esc_html__('Bottom', 'tvr-microthemer'),
    'label' => esc_attr__('Padding Bottom', 'tvr-microthemer'),
    'input-class' => 'size-0',
    'auto' => array(
        '%' => array(
            'node' => 'parent',
...
$propertyOptions['padding_margin']['padding_left'] = array(
    'short_label' => esc_html__('Left', 'tvr-microthemer'),
    'label' => esc_attr__('Padding Left', 'tvr-microthemer'),
    'input-class' => 'size-0',
    'auto' => array(
        '%' => array(
            'node' => 'parent',
...
$propertyOptions['padding_margin']['margin_top'] = array(
    'short_label' => esc_html__('Top', 'tvr-microthemer'),
    'label' => esc_attr__('Margin Top', 'tvr-microthemer'),
...
$propertyOptions['padding_margin']['margin_right'] = array(
    'short_label' => esc_html__('Right', 'tvr-microthemer'),
    'label' => esc_attr__('Margin Right', 'tvr-microthemer'),
    'input-class' => 'size-0',
    'auto' => array(
        '%' => array(
            'node' => 'parent',
...
$propertyOptions['padding_margin']['margin_bottom'] = array(
    'short_label' => esc_html__('Bottom', 'tvr-microthemer'),
    'label' => esc_attr__('Margin Bottom', 'tvr-microthemer'),
    'input-class' => 'size-0',
    'auto' => array(
        '%' => array(
            'node' => 'parent',
...
$propertyOptions['padding_margin']['margin_left'] = array(
    'short_label' => esc_html__('Left', 'tvr-microthemer'),
    'label' => esc_attr__('Margin Left', 'tvr-microthemer'),
    'input-class' => 'size-0',
    'auto' => array(
        '%' => array(
            'node' => 'parent',
...
$propertyOptions['border']['border_top_color'] = array(
    'short_label' => esc_html__('Top', 'tvr-microthemer'),
    'label' => esc_attr__('Border Top Color', 'tvr-microthemer'),
...
$propertyOptions['border']['border_right_color'] = array(
    'short_label' => esc_html__('Right', 'tvr-microthemer'),
    'label' => esc_attr__('Border Right Color', 'tvr-microthemer'),
    'rel' => 'border_color',
    'field-class' => 'is-picker',
    'input-class' => 'color',
    'icon' => '13, 14',
...
$propertyOptions['border']['border_bottom_color'] = array(
    'short_label' => esc_html__('Bottom', 'tvr-microthemer'),
    'label' => esc_attr__('Border Bottom Color', 'tvr-microthemer'),
    'rel' => 'border_color',
    'field-class' => 'is-picker',
    'input-class' => 'color',
    'icon' => '11, 14',
...
$propertyOptions['border']['border_left_color'] = array(
    'short_label' => esc_html__('Left', 'tvr-microthemer'),
    'label' => esc_attr__('Border Left Color', 'tvr-microthemer'),
    'rel' => 'border_color',
...
$propertyOptions['border']['border_top_width'] = array(
    'short_label' => esc_html__('Top', 'tvr-microthemer'),
    'label' => esc_attr__('Border Top Width', 'tvr-microthemer'),
    'sub_label' => __('Border Width', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'auto' => array(
        '%' => false
    ),
    'default_unit' => array('px (implicit)', 'px (implicit)', 'px (implicit)'),
    'rel' => 'border_width',
    'icon' => '6, 14',
    // ref
...
$propertyOptions['border']['border_right_width'] = array(
    'short_label' => esc_html__('Right', 'tvr-microthemer'),
    'label' => esc_attr__('Border Right Width', 'tvr-microthemer'),
    'auto' => array(
        '%' => false
    ),
    'default_unit' => array('px (implicit)', 'px (implicit)', 'px (implicit)'),
...
$propertyOptions['border']['border_bottom_width'] = array(
    'short_label' => esc_html__('Bottom', 'tvr-microthemer'),
    'label' => esc_attr__('Border Bottom Width', 'tvr-microthemer'),
    'auto' => array(
        '%' => false
    ),
    'default_unit' => array('px (implicit)', 'px (implicit)', 'px (implicit)'),
...
$propertyOptions['border']['border_left_width'] = array(
    'short_label' => esc_html__('Left', 'tvr-microthemer'),
    'label' => esc_attr__('Border Left Width', 'tvr-microthemer'),
    'auto' => array(
        '%' => false
    ),
    'default_unit' => array('px (implicit)', 'px (implicit)', 'px (implicit)'),
...
$propertyOptions['border']['border_top_style'] = array(
    'short_label' => esc_html__('Top', 'tvr-microthemer'),
    'label' => esc_attr__('Border Top Style', 'tvr-microthemer'),
...
$propertyOptions['border']['border_right_style'] = array(
    'short_label' => esc_html__('Right', 'tvr-microthemer'),
    'label' => esc_attr__('Border Right Style', 'tvr-microthemer'),
    'type' => 'combobox',
    'rel' => 'border_style',
    'select_options' => $border_style_options,
    'icon' => '17, 14',
...
$propertyOptions['border']['border_bottom_style'] = array(
    'short_label' => esc_html__('Bottom', 'tvr-microthemer'),
    'label' => esc_attr__('Border Bottom Style', 'tvr-microthemer'),
    'type' => 'combobox',
    'rel' => 'border_style',
    'select_options' => $border_style_options,
    'icon' => '15, 14',
...
$propertyOptions['border']['border_left_style'] = array(
    'short_label' => esc_html__('Left', 'tvr-microthemer'),
    'label' => esc_attr__('Border Left Style', 'tvr-microthemer'),
    'type' => 'combobox',
    'field-class' => 'last',
    'rel' => 'border_style',
    'select_options' => $border_style_options,
...
$propertyOptions['border']['border_top_left_radius'] = array(
    'short_label' => esc_html__('Top Left', 'tvr-microthemer'),
    'label' => esc_attr__('Top Left Border Radius', 'tvr-microthemer'),
...
$propertyOptions['border']['border_top_right_radius'] = array(
    'short_label' => esc_html__('Top Right', 'tvr-microthemer'),
    'label' => esc_attr__('Top Right Border Radius', 'tvr-microthemer'),
    'auto' => array(
        '%' => $border_radius_unconvertable
    ),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
...
$propertyOptions['border']['border_bottom_right_radius'] = array(
    'short_label' => esc_html__('Bottom Right', 'tvr-microthemer'),
    'label' => esc_attr__('Bottom Right Border Radius', 'tvr-microthemer'),
    'auto' => array(
        '%' => $border_radius_unconvertable
    ),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
...
$propertyOptions['border']['border_bottom_left_radius'] = array(
    'short_label' => esc_html__('Bottom Left', 'tvr-microthemer'),
    'label' => esc_attr__('Bottom Left Border Radius', 'tvr-microthemer'),
    'auto' => array(
        '%' => $border_radius_unconvertable
    ),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
...
$propertyOptions['behaviour']['display'] = array(
    'short_label' => esc_html(_x('Display', 'noun', 'tvr-microthemer')),
    'label' => esc_attr(_x('Display', 'noun', 'tvr-microthemer')),
...
$propertyOptions['behaviour']['overflow'] = array(
    'short_label' => esc_html__('Overflow', 'tvr-microthemer'),
    'label' => esc_attr__('Overflow', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-2',
    'type' => 'combobox',
    'select_options' => array(
...
$propertyOptions['behaviour']['overflow_x'] = array(
    'short_label' => esc_html__('Overflow X', 'tvr-microthemer'),
    'label' => esc_attr__('Overflow X', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-2',
    'type' => 'combobox',
    'select_options' => array(
...
$propertyOptions['behaviour']['overflow_y'] = array(
    'short_label' => esc_html__('Overflow Y', 'tvr-microthemer'),
    'label' => esc_attr__('Overflow Y', 'tvr-microthemer'),
    'field-class' => 'icon-size-4',
    'input-class' => 'size-2',
    'type' => 'combobox',
    'select_options' => array(
...
$propertyOptions['behaviour']['visibility'] = array(
    'short_label' => esc_html__('Visibility', 'tvr-microthemer'),
    'label' => esc_attr__('Visibility', 'tvr-microthemer'),
    'type' => 'combobox',
    'input-class' => 'size-3',
    'select_options' => array(
		'',
...
$propertyOptions['behaviour']['cursor'] = array(
    'short_label' => esc_html__('Cursor', 'tvr-microthemer'),
    'label' => esc_attr__('Cursor', 'tvr-microthemer'),
    'field-class' => 'icon-size-0a',
    'input-class' => 'size-3',
    'type' => 'combobox',
    'select_options' => array(
...
$propertyOptions['behaviour']['opacity'] = array(
    'short_label' => esc_html__('Opacity', 'tvr-microthemer'),
    'label' => esc_attr__('Opacity', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-0b',
    'icon' => '4, 14',
    // ref
...
$propertyOptions['position']['position'] = array(
    'short_label' => esc_html__('Position', 'tvr-microthemer'),
    'label' => esc_attr__('Position', 'tvr-microthemer'),
...
$propertyOptions['position']['top'] = array(
    'short_label' => esc_html__('Top', 'tvr-microthemer'),
    'label' => esc_attr__('Top (Position)', 'tvr-microthemer'),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
    'icon' => '11',
    // ref
...
$propertyOptions['position']['bottom'] = array(
    'short_label' => esc_html__('Bottom', 'tvr-microthemer'),
    'label' => esc_attr__('Bottom (Position)', 'tvr-microthemer'),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
    'icon' => '12',
    // ref
...
$propertyOptions['position']['left'] = array(
    'short_label' => esc_html__('Left', 'tvr-microthemer'),
    'label' => esc_attr__('Left (Position)', 'tvr-microthemer'),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
    'icon' => '13',
    // ref
...
$propertyOptions['position']['right'] = array(
    'short_label' => esc_html__('Right', 'tvr-microthemer'),
    'label' => esc_attr__('Right (Position)', 'tvr-microthemer'),
    'default_unit' => array('px (implicit)', 'em', 'px to em'),
    'icon' => '14',
    'field-class' => 'last',
    // ref
...
$propertyOptions['position']['z_index'] = array(
    'short_label' => esc_html__('Z-index', 'tvr-microthemer'),
    'label' => esc_attr__('Z-index', 'tvr-microthemer'),
    'icon' => '21, 14',
    // ref
...
$propertyOptions['position']['float'] = array(
    'short_label' => esc_html__('Float', 'tvr-microthemer'),
    'label' => esc_attr__('Float', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-0',
    'type' => 'combobox',
    'select_options' => array(
...
$propertyOptions['position']['clear'] = array(
    'short_label' => esc_html__('Clear', 'tvr-microthemer'),
    'label' => esc_attr__('Clear', 'tvr-microthemer'),
    'field-class' => 'icon-size-2',
    'input-class' => 'size-0',
    'type' => 'combobox',
    'select_options' => array(
...
$propertyOptions['gradient']['gradient_angle'] = array(
    'short_label' => esc_html__('Angle', 'tvr-microthemer'),
    'label' => esc_attr__('Gradient Angle', 'tvr-microthemer'),
...
$propertyOptions['gradient']['gradient_a'] = array(
    'short_label' => 'A',
    'label' => esc_attr__('Gradient A', 'tvr-microthemer'),
...
$propertyOptions['gradient']['gradient_b'] = array(
    'short_label' => 'B',
    'label' => esc_attr__('Gradient B', 'tvr-microthemer'),
    'field-class' => 'always-label is-picker',
    'input-class' => 'color',
    'hide imp' => 1,
    'icon' => '25',
...
$propertyOptions['gradient']['gradient_b_pos'] = array(
    'short_label' => esc_html__('B Position', 'tvr-microthemer'),
    'label' => esc_attr__('Gradient B Position', 'tvr-microthemer'),
    'field-class' => 'icon-size-0b',
    'auto' => array(
...
$propertyOptions['gradient']['gradient_c'] = array(
    'short_label' => 'C',
    'label' => esc_attr__('Gradient C', 'tvr-microthemer'),
    'field-class' => 'always-label is-picker',
    'input-class' => 'color',
    'icon' => '25',
    // ref
