...
<div id="tvr" class='wrap tvr-wrap <?php echo $ui_class; ?>'>
	<div id='tvr-ui'>
        ...
        <div id="visual-view" class="<?php echo $main_class; ?>">
            ...
            <div id="v-top-controls">
                <div id='hand-css-area'>
                    <div id="custom-code-toolbar">
						<div class="heading"><?php esc_html_e('Enter your own custom CSS code', 'tvr-microthemer'); ?></div>
                    </div>

                    <div id="code-editors-wrap">
                        <div id="css-tab-areas" class="query-tabs css-code-tabs">
                        <span class="edit-code-tabs show-dialog"
                              title="<?php esc_attr_e('Edit custom code tabs', 'tvr-microthemer'); ?>" rel="edit-code-tabs">
                        </span>
                            ...
                            $tab_headings = array(
                                'all-browsers' => esc_html__('All Browsers', 'tvr-microthemer'),
                                'all' => esc_html__('All versions of IE', 'tvr-microthemer'),
                                'nine' => esc_html__('IE9 and below', 'tvr-microthemer'),
                                'eight' => esc_html__('IE8 and below', 'tvr-microthemer'),
                                'seven' => esc_html__('IE7 and below', 'tvr-microthemer')
                            );
                ...
                <div id="tvr-nav" class="tvr-nav">
                    <div id="quick-nav" class="quick-nav">
						<span id="vb-focus-prev" class="scroll-buttons tvr-icon" title="<?php esc_attr_e("Go To Previous Selector", "tvr-microthemer"); ?>"></span>
						<span id="vb-focus-next" class="scroll-buttons tvr-icon" title="<?php esc_attr_e("Go To Next Selector", "tvr-microthemer"); ?>"></span>
                        <?php
                        // for quick debugging
                        echo $this->show_me;
                        ?>
                    ...
                    <div id="tvr-main-menu" class="tvr-main-menu-wrap">
						<span class="main-menu-tip-trigger" title="<?php esc_attr_e("Manage folders & selectors", "tvr-microthemer"); ?>"></span>
                        <div id="main-menu-popdown" class="main-menu-popdown">
                            <div id="add-new-section">
                                <div class="inner-wrap">
                                    <div class='new-section'>
										<input type='text' data-ph-title="<?php esc_attr_e('Enter a new folder name', 'tvr-microthemer'); ?>" class='new-section-input' name='new_section[name]' value='' />
										<span class='new-section-add tvr-button' title="<?php esc_attr_e("Create a new folder", "tvr-microthemer"); ?>"><?php esc_html_e('Add Folder', 'tvr-microthemer'); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="ui-totals-count">
								...
								<span class="total-folders"><?php esc_html_e('Folders', 'tvr-microthemer'); ?>&nbsp;&nbsp;</span>

                                <span class="tvr-icon selector-icon"></span>
                                <span id="total-sel-count"><?php echo $this->total_selectors; ?></span>
								<span><?php esc_html_e('Selectors', 'tvr-microthemer'); ?></span>

                            </div>
                        </div>
                    </div>
                    <span id="current-selector"></span>
                    <div id="starter-message"><?php esc_html_e("Double-click anything on the page to begin restyling it.", "tvr-microthemer"); ?></div>
                </div>
                ...
                if (!$this->preferences['buyer_validated']){
                    ...
                    <div class="cta-wrap">
                        <a class="cta-button buy-cta tvr-button red-button" href="http://themeover.com" target="_blank"
                           title="<?php esc_attr_e('Purchase a license to use the full program', 'tvr-microthemer'); ?>">
                            <span class="tvr-icon"></span>
                            <span class="cta-label"><?php esc_html_e('Buy', 'tvr-microthemer'); ?></span>
                        </a>
                            <span class="cta-button unlock-cta tvr-button show-dialog"
                                  title="<?php esc_attr_e("If you have purchased Microthemer you can enter your email address to unlock the full program. If you have not yet purchased Microthemer, you cannot unlock the full version.", "tvr-microthemer"); ?>" rel="unlock-microthemer">
                                <span class="tvr-icon show-dialog" rel="unlock-microthemer"></span>
                                <span class="cta-label show-dialog" rel="unlock-microthemer"><?php esc_html_e("Unlock", "tvr-microthemer"); ?></span>
                            </span>
                    </div>
                <?php
                }
                ...
                <div class="right-stuff-wrap">
                    ...
                    <div id="status-board" class="tvr-popdown-wrap">
                        ...
                        <div id="full-logs" class="tvr-popdown scrollable-area">
							<div class="heading"><?php esc_html_e('Microthemer Notifications', 'tvr-microthemer'); ?></div>
                            <?php
            ...
            <div id="advanced-wizard">
                ...
                <div class="heading dialog-header">
					...
					<span class="text"><?php esc_html_e('Create a Selector', 'tvr-microthemer'); ?> <!--<a href="#" target="_blank">(learn how)</a>--></span>
                        <span class="cancel-wizard cancel tvr-icon close-icon"
                              title="<?php esc_attr_e("Close the selector wizard", "tvr-microthemer"); ?>"></span>
                </div>
                ...
                <div id="selector-wizard">
                    <div class="quick-create">
                        ...
                        <div class="quick-wrap wiz-name">
                            <label title="<?php esc_attr_e("Give your selector a memorable name that describes the element or set of elements on the page", "tvr-microthemer"); ?>"><?php esc_html_e('Name', 'tvr-microthemer'); ?>:</label>
                        ...
                        <div class="quick-wrap wiz-folder">
                            <label data-ph-title="<?php esc_attr_e("Organise your selector into a folder", "tvr-microthemer"); ?>"><?php esc_html_e('Folder', 'tvr-microthemer'); ?>:</label>
                                <span class="input-wrap wizard-folder-wrap" >
                                   <input type="text" class="combobox wizard-folder wizard-input"
                                          ...
                                          data-ph-title="<?php esc_attr_e("Enter new or select a folder...", "tvr-microthemer"); ?>" />
                ...
                <div id="adv-tabs" class="query-tabs">
                    ...
                    $tab_headings = array(
                        'refine-targeting' => esc_html__('Targeting', 'tvr-microthemer'),
                        'html-inspector' => esc_html__('Inspector', 'tvr-microthemer')
                    );
                    foreach ($tab_headings as $key => $value) {
                    ...
                    if ($adv_wizard_focus == 'html-inspector') {
                        ...
                        <div id="refine-target">
                            <div class="refine-target-controls">
                                <span class="tvr-prev-sibling refine-button" title="<?php esc_attr_e("Move to Previous Sibling Element", "tvr-microthemer"); ?>"></span>
                                <div class="updown-wrap">
                                    <span class="tvr-parent refine-button" title="<?php esc_attr_e("Move to Parent Element", "tvr-microthemer"); ?>"></span>
                                    <span class="tvr-child refine-button" title="<?php esc_attr_e("Move to Child Element", "tvr-microthemer"); ?>"></span>
                                </div>
                                <span class="tvr-next-sibling refine-button" title="<?php esc_attr_e("Move to Next Sibling Element", "tvr-microthemer"); ?>"></span>
                            </div>
                                ...
                                foreach ($this->property_option_groups as $property_group => $pg_label) {
                                    ...
                                    <ul id="comp-<?php echo $property_group; ?>" class="accordion-menu <?php if ($i&1) { echo 'odd'; } ?>">
                                        <li class="css-group-heading accordion-heading">
                                            <span class="menu-arrow accordion-menu-arrow tvr-icon" title="<?php esc_attr_e("Open/close group", "tvr-microthemer"); ?>"></span>
                ...
                <div class="create-sel-wrap">
                    <span class='wizard-add tvr-button' title="<?php esc_attr_e("Create a new selector", "tvr-microthemer"); ?>"><?php esc_html_e('Create Selector', 'tvr-microthemer'); ?></span>
                </div>
        ...
        <div id="m-logo" class="v-left-button m-logo <?php echo $interface_class; ?>"
             title="<?php esc_attr_e("Expand/collapse the interface", "tvr-microthemer"); ?>" rel="http://themeover.com/"></div>
    ...
    if (!$this->optimisation_test){
        ...
        <div id="dialogs">
            ...
            <form name='tvr_validate_form' method="post"
                ...
                <?php
                if ($this->preferences['buyer_validated']){
                    $title = esc_html__('Microthemer Has Been Successfully Unlocked', 'tvr-microthemer');
                } else {
                    $title = esc_html__('Enter your PayPal email to unlock Microthemer', 'tvr-microthemer');
                }
                ...
                <div class="content-main">
                    ...
                    if ($this->preferences['buyer_validated']){
                        ...
                        if (!empty($this->preferences['license_type'])){
                            echo '<p>' . esc_html__('License Type: ', 'tvr-microthemer') . '<b>'.$this->preferences['license_type'].'</b></p>';
                        }
                        ?>
						<p><span class="link reveal-unlock"><?php esc_html_e('Validate software using a different email address', 'tvr-microthemer'); ?></span>
                        </p>
                    <?php
                    } else {
                        $class = 'show';
                    ...
                    <div id='tvr_validate_form' class='hidden <?php echo $class; ?>'>
                        ...
                        <ul class="form-field-list">
                            <li>
								<label class="text-label" title="<?php esc_attr_e("Enter your PayPal or Email Address - or the email address listed on 'My Downloads'", "tvr-microthemer"); ?>"><?php esc_html_e('Enter PayPal email or see email in "My Downloads"', 'tvr-microthemer'); ?></label>
                        ...
                        <div class="explain">
							<div class="heading link explain-link"><?php esc_html_e('About this feature', 'tvr-microthemer'); ?></div>

                            <div class="full-about">
							<p><?php printf(
								wp_kses(
									__('To disable Free Trial Mode and unlock the full program, please enter your PayPal email address. If you purchased Microthemer from CodeCanyon, please send us a "Validate my email" message via the contact form on the right hand side of <a %s>this page</a> (you will need to log in to CodeCanyon first). Receiving this email allows us to verify your purchase.', 'tvr-microthemer'),
									array( 'a' => array('href' => array(), 'target' => array()) )
								),
								'target="_blank" href="http://codecanyon.net/user/themeover"'
							); ?></p>
								<p><?php echo wp_kses(
									__('<b>Note:</b> Themeover will record your domain name when you submit your email address for license verification purposes.', 'tvr-microthemer'),
									array( 'b' => array() )
								) ; ?></p>
								<p><?php printf(
									wp_kses(
										__('<b>Note:</b> if you have any problems with the validator <a %s>send Themeover a quick email</a> and we"ll get you unlocked ASAP.', 'tvr-microthemer'),
                ...
                <?php
                if (!$this->preferences['buyer_validated']){
                    echo $this->end_dialog(esc_html__('Validate', 'tvr-microthemer'), 'input', 'ui-validate');
                } else {
                    echo $this->end_dialog(esc_html(_x('Close', 'verb', 'tvr-microthemer')), 'span', 'close-dialog');
                }
                ?>
            </form>
            ...
            <form id="edit-media-queries-form" name='tvr_media_queries_form' method="post" autocomplete="off"
                ...
                <?php echo $this->start_dialog('edit-media-queries', esc_html__('Edit Media Queries (For Designing Responsively)', 'tvr-microthemer'), 'small-dialog'); ?>
                ...
                <div class="content-main">
                    ...
                    <ul class="form-field-list">
                        ...
                        ?>
						<li><span class="reveal-hidden-form-opts link reveal-mq-sets" rel="mq-set-opts"><?php esc_html_e('Load an alternative media query set', 'tvr-microthemer'); ?></span></li>
                        <?php
					...
					<div class="heading"><?php esc_html_e('Media Queries', 'tvr-microthemer'); ?></div>
                    ...
                    <div id="m-queries">
						...
						<span id="add-m-query" class="tvr-button add-m-query" rel="<?php echo $i; ?>"><?php esc_html_e('+ New', 'tvr-microthemer'); ?></span>
            ...
            <form id="edit-code-tabs" name='tvr_code_tabs_form' method="post" autocomplete="off"
                ...
                <?php echo $this->start_dialog('edit-code-tabs', esc_html__('Manage Custom Code Editors', 'tvr-microthemer'), 'small-dialog'); ?>
                ...
                <?php
                echo $this->end_dialog(esc_html__('Update Custom Code Tabs', 'tvr-microthemer'), 'input', 'update-custom-code-tabs');
                ?>
            </form>
            ...
            <form method="post" id="microthemer_ui_settings_import" autocomplete="off">
                ...
                <?php echo $this->start_dialog('import-from-pack', esc_html__('Import settings from a design pack', 'tvr-microthemer'), 'small-dialog'); ?>

                <div class="content-main">
					<p><?php esc_html_e('Select a design pack to import', 'tvr-microthemer'); ?></p>
					...
					<p class="enter-name-explain"><?php esc_html_e('Choose to overwrite or merge the imported settings with your current settings', 'tvr-microthemer'); ?></p>

                    <ul id="overwrite-merge" class="checkboxes fake-radio-parent">
						<li><input name="tvr_import_method" type="radio" value="<?php esc_attr_e('Overwrite', 'tvr-microthemer'); ?>" id='ui-import-overwrite'
                                  class="radio ui-import-method" />
                            <span class="fake-radio"></span>
							<span class="ef-label"><?php esc_html_e('Overwrite', 'tvr-microthemer'); ?></span>
                        </li>
						<li><input name="tvr_import_method" type="radio" value="<?php esc_attr_e('Merge', 'tvr-microthemer'); ?>" id='ui-import-merge'
                                  class="radio ui-import-method" />
                            <span class="fake-radio"></span>
							<span class="ef-label"><?php esc_html_e('Merge', 'tvr-microthemer'); ?></span>
                        </li>
                    </ul>
                    <?php /*
                    ...
                    <div class="explain">
                        ...
                        <div class="full-about">
							...
							<p><?php printf(
								esc_html__('Note: you can install other people\'s design packs via the "%s" window.', 'tvr-microthemer'),
								'<span class="link show-dialog" rel="manage-design-packs">' . __('Manage Design Packs', 'tvr-microthemer') . '</span>'
							); ?></p>
							<p><b><?php esc_html_e('You may want to make use of this feature for the following reasons:', 'tvr-microthemer'); ?></b></p>
                            <ul>
							<li><?php printf(
								esc_html__('You\'ve download and installed a design pack that you found on %s for restyling a theme, contact form, or any other WordPress content you can think of. Importing it will load the folders and hand-coded CSS contained within the design pack into the Microthemer UI.', 'tvr-microthemer'),
								'<a target="_blank" href="http://themeover.com/">themeover.com</a>'
								); ?></li>
								<li><?php esc_html_e('You previously exported your own work as a design pack and now you would like to reload it back into the Microthemer UI.', 'tvr-microthemer'); ?></li>
                            </ul>
                        </div>
                    </div>
                    <br /><br /><br /><br />
                </div>
                <?php echo $this->end_dialog(esc_html(_x('Import', 'verb', 'tvr-microthemer')), 'span', 'ui-import'); ?>
            </form>
            ...
            <?php echo $this->start_dialog('export-to-pack', esc_html__('Export your work as a design pack', 'tvr-microthemer'), 'small-dialog'); ?>
            ...
            <div class="content-main export-form">
				...
				<p class="enter-name-explain"><?php esc_html_e('Enter a new name or export to an existing design pack. Uncheck any folders or custom CSS you don\'t want included in the export.', 'tvr-microthemer'); ?></p>
                <p class="combobox-wrap input-wrap">
				...
				<div class="heading"><?php esc_html_e('Folders', 'tvr-microthemer'); ?></div>
                <ul id="toggle-checked-folders" class="checkboxes">
                    <li><input type="checkbox" name="toggle_checked_folders" checked="checked"/>
						...
						<span class="ef-label"><b><?php esc_html_e('Check All', 'tvr-microthemer'); ?></b></span>
                    </li>
                </ul>
                <ul id="available-folders" class="checkboxes"></ul>

				<div class="heading"><?php esc_html_e('Custom CSS', 'tvr-microthemer'); ?></div>
                <ul id="custom-css" class="checkboxes">
                    ...
                    <li>
						...
						<span class="ef-label"><?php esc_html_e('Hand coded CSS (all browsers)', 'tvr-microthemer'); ?></span>
                    </li>
                    <?php
                    $tab_headings = array(
                        'all' => esc_html__('IE-specific CSS code', 'tvr-microthemer'),
                        'nine' => esc_html__('IE9 and below CSS code', 'tvr-microthemer'),
                        'eight' => esc_html__('IE8 and below CSS code', 'tvr-microthemer'),
						'seven' => esc_html__('IE7 and below CSS code', 'tvr-microthemer')
					);
 ...
 */ ?>
                ...
                <div class="explain">
                    ...
                    <div class="full-about">
                        ...
                        <ul>
							<li><?php printf(
								esc_html__('To make extra sure that your work is backed up (even though there is an automatic revision restore feature). After exporting your work to a design pack you can also download it as a zip package for extra reassurance. You can do this from the "%s" window.', 'tvr-microthemer'),
								'<span class="link show-dialog" rel="manage-design-packs">' . esc_html__('Manage Design Packs', 'tvr-microthemer') . '</span>'
							); ?></li>
							<li><?php esc_html_e('To save your current work but then start a fresh (using the "reset" option in the left-hand menu)', 'tvr-microthemer'); ?></li>
							<li><?php esc_html_e('To save one aspect of your design for reuse in other projects (e.g. styling for a menu). You can do this by organising the styles you plan to reuse into a folder and then export only that folder to a design pack by unchecking the other folders before clicking the "Export" button.', 'tvr-microthemer'); ?></li>
							<li><?php printf(
								esc_html__('To submit a design pack for sale or free download on %s', 'tvr-microthemer'),
								'<a target="_blank" href="http://themeover.com/">themeover.com</a>'
							); ?></li>
                        </ul>
                    </div>
            ...
            <?php echo $this->end_dialog(esc_html(_x('Export', 'verb', 'tvr-microthemer')), 'span', 'export-dialog-button'); ?>
            </form>


            <!-- View CSS -->
            <?php echo $this->start_dialog('display-css-code', esc_html__('View the CSS code Microthemer generates', 'tvr-microthemer'), 'small-dialog'); ?>
            ...
            <div class="content-main">
                ...
                <div class="explain">
                    ...
                    <div class="full-about">
						<p><?php esc_html_e('What you see above is the CSS code Microthemer is currently generating. This can sometimes be useful for debugging issues if you know CSS. Or if you want to reuse the code Microthemer generates elsewhere.', 'tvr-microthemer'); ?></p>
						<p><?php printf(
							wp_kses(
								__('<b>Did you know</b> - it\'s possible to disable or completely uninstall Microthemer and still use the customisations. You just need to paste a small piece of code in your theme\'s functions.php file. See this <a %s>forum post</a> for further information.', 'tvr-microthemer'),
								array( 'a' => array( 'href' => array(), 'target' => array() ), 'b' => array() )
							),
						...
						<p><?php printf(
							...
							'<a target="_blank" href="http://themeover.com/beginners-guide-to-understanding-css-specificity/">' . __('CSS specificity', 'tvr-microthemer') . '</a>',
            ...
            <?php echo $this->end_dialog(esc_html(_x('Close', 'verb', 'tvr-microthemer')), 'span', 'close-dialog'); ?>

            <!-- Restore Settings -->
            <?php echo $this->start_dialog('display-revisions', esc_html__('Restore settings from a previous save point', 'tvr-microthemer'), 'small-dialog'); ?>
            ...
            <div class="content-main">
				...
				<div class="heading link explain-link"><?php esc_html_e('About this feature', 'tvr-microthemer'); ?></div>
                    <div class="full-about">
					<p><?php esc_html_e('Click the "restore" link in the right hand column of the table to restore your workspace settings to a previous save point.', 'tvr-microthemer'); ?></p>
                    </div>
                </div>
            </div>
            <?php echo $this->end_dialog(esc_html(_x('Close', 'verb', 'tvr-microthemer')), 'span', 'close-dialog'); ?>
            ...
            <!-- Spread the word -->
            <?php echo $this->start_dialog('display-share', esc_html__('Show off your new discovery', 'tvr-microthemer'), 'small-dialog'); ?>
            <div class="content-main">
                <div class="explain">
					<div class="heading link explain-link"><?php esc_html_e('About this feature', 'tvr-microthemer'); ?></div>
                    <div class="full-about">
						<p><?php esc_html_e('cash back feature - coupon code to give new customer, affiliate commission for existing', 'tvr-microthemer'); ?></p>
						<p><?php esc_html_e('For now, just a simply share widget.', 'tvr-microthemer'); ?></p>
                    </div>
                </div>
            </div>
            <?php echo $this->end_dialog(esc_html(_x('Close', 'verb', 'tvr-microthemer')), 'span', 'close-dialog'); ?>
        ...
        <!-- Manage Design Packs -->
        <?php echo $this->start_dialog('manage-design-packs', esc_html__('Install & Manage Design Packs', 'tvr-microthemer')); ?>
        ...
        <!-- Program Docs -->
        <?php echo $this->start_dialog('program-docs', esc_html__('Help Centre', 'tvr-microthemer')); ?>
        ...
        <!-- Integration -->
        <?php echo $this->start_dialog('integration', esc_html__('Integration with 3rd party software', 'tvr-microthemer'), 'small-dialog'); ?>
        <div class="content-main">
			<div class="heading"><?php esc_html_e('WPTouch Mobile Plugin', 'tvr-microthemer'); ?></div>
			<p><?php printf(
				wp_kses(
			...
			<div class="heading link explain-link"><?php esc_html_e('About this feature', 'tvr-microthemer'); ?></div>
                <div class="full-about">
					<p><?php esc_html_e('When possible, we\'ll add little features to make it easier to use Microthemer with complementary products.', 'tvr-microthemer'); ?></p>
                </div>
            </div>
        </div>
        <?php echo $this->end_dialog(esc_html(_x('Close', 'verb', 'tvr-microthemer')), 'span', 'close-dialog'); ?>
    ...
    <form action='#' name='dummy' id="html-templates">
        ...
        if (!$this->optimisation_test){
			...
			$long =
				'<p>' . sprintf(
                    esc_html__('Please %s. The error report sends us information about your current Microthemer settings, server and browser information, and your WP admin email address. We use this information purely for replicating your issue and then contacting you with a solution.', 'tvr-microthemer'),
					'<span id="email-error" class="link">' . __('click this link to email an error report to Themeover', 'tvr-microthemer') . '</span>'
				) . '</p>
			    <p>' . wp_kses(
                        __('<b>Note:</b> reloading the page is normally a quick fix for now. However, unsaved changes will need to be redone.', 'tvr-microthemer'),
                        array( 'b' => array()
                        )
                ). '</p>';
