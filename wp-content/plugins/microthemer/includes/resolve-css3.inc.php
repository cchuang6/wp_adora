...
!$array['styles']['box_shadow']['rendered']) {
	...
	// !important is a bit different for css3 - only one "i" per line - do another check
	$sty['css_important'] = $this->tvr_css3_imp($section_name_slug, $css_selector_slug, $property_group_name, 'box_shadow_inset', $con, $mq_key);
...
!$array['styles']['text_shadow']['rendered']) {
	...
	// !important is a bit different for css3 - only one "i" per line - do another check
	$sty['css_important'] = $this->tvr_css3_imp($section_name_slug, $css_selector_slug, $property_group_name, 'text_shadow_color', $con, $mq_key);
