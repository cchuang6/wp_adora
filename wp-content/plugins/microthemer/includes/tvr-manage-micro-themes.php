                    ...
                    <div class="pack">
                        ...
                        <a href="<?php echo $url ; ?>">
                            <img src="<?php echo $screenshot; ?>" width="145" height="83"
                                 title="<?php printf(esc_attr__('Edit %s', 'tvr-microthemer'), $name); ?>" />
                        </a>
                        <div class="pack-quick-icons">
							<span class="tvr-icon delete-icon delete-pack-multi" title="<?php printf(esc_attr__('Delete %s', 'tvr-microthemer'), $name); ?>"
                                  rel="delete" data-dir-name="<?php echo $pack; ?>"></span>

							<span class="tvr-icon download-icon download-pack-multi" title="<?php printf(esc_attr__('Download %s', 'tvr-microthemer'), $name); ?>"
                                  rel="download" data-dir-name="<?php echo $pack; ?>"></span>

							<a href="<?php echo $url ; ?>" title="<?php printf(esc_attr__('Edit %s', 'tvr-microthemer'), $name); ?>"><span class="tvr-icon edit-icon"></span></a>
